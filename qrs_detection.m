...
%
% Funci�n que implementa el algoritmo de Pan y Tompkins para la detecci�n
% de los complejos QRS en una  se�al de ECG.
% 
% Entrada: 
...
while  n<=length(fm),
  if n==720, % inicializaci�n de los umbrales
      aux = fm(1:n);
